...
const adicionarParticipante = (event) => {
  ...
  const dadsDoFormulario = new FormData(event.target)

const participante = {
nome: dadsDoFormulario.get('nome'),
email: dadsDoFormulario.get('email'),
...
//confirmar se realmente quer fazer  o login
 const mensagaemConfirmacao = 'Tem certeza que deseja fazer o Check-in?'

  if(confirm(mensagaemConfirmacao) == false) {
   return 
...
//atualizar o Check-in do participantes
